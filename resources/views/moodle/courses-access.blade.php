            ...
            success: function (data) {
                ...
                $.each(data, function(index, acesso){
                    ...
                    dados.push({
                        'CPF': acesso.cpf,
                        'E-mail': acesso.email,
                        'Nome': '<a target="_blank" href="access_activity.html?userid='+acesso.id+'&courseid='+courseid+'&date_initial='+$('#date_initial').val()+'&date_final='+$('#date_final').val()+'">'+acesso.nome+'</a>',
                        'Polo': acesso.grupo,
